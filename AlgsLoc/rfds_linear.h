...
class linear_hash_table {
   public:
    ...
    linear_hash_table(int size, double load_factor, int _index_seed, uint64_t curTime, uint32_t _area) {
...
#define C 240.0
   ...
   public:
    ...
    void init(double _alpha, double _memory, int _, double load_factor, uint32_t _FP_SEED, uint32_t _INDEX_SEED, uint64_t curTime, uint32_t window, uint32_t _area) {
        ...
        B = new linear_hash_table(max_elements, load_factor, INDEX_SEED, curTime, _area);
    }
